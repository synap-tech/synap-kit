...
const fieldVariants = cva(
  'group/field flex w-full h-fit gap-3 data-[invalid=true]:text-destructive dark:data-[invalid=true]:text-destructive',
  {
    variants: {
      orientation: {
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn(
        'text-destructive text-sm font-normal dark:text-destructive',
        className
      )}
      {...props}
    >
