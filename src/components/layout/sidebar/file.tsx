...
//         className={({ isActive }) =>
//           cn(
//             'relative flex items-center w-full justify-between gap-2 rounded-lg border-l-[3px]  px-4 py-2 text-sm transition-colors duration-200 font-normal font-geist',
