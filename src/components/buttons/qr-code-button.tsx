...
export const QRButton: React.FC<QRButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      'text-blue-600 hover:bg-blue-100 hover:text-blue-700 active:bg-blue-200 focus:ring-blue-500',
    secondary:
    ...
    ghost:
      'text-gray-600 hover:bg-gray-100 hover:text-gray-800 active:bg-gray-200 focus:ring-gray-500',
  };
